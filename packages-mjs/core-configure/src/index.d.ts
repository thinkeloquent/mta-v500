...
export { type ConfigLayer, type ConfigMetadata, ConfigSource, type ConfigurationManagerOptions, ConfigurationManagerOptionsSchema, type EntityConfig, EntityConfigSchema, type EntityDefinition, EntityDefinitionSchema, type MergeOptions, MergeStrategy, type ValidationResult, } from './types.js';
