 ...
 */
export const defaultConfig: ProcessExceptionOptions = {
 ...
 */
export const devConfig: ProcessExceptionOptions = {
  enableErrorHandler: true,
  enableGracefulShutdown: true,
  enableProcessHandlers: true,
 ...
 */
export const prodConfig: ProcessExceptionOptions = {
  enableErrorHandler: true,
  enableGracefulShutdown: true,
  enableProcessHandlers: true,
 ...
 */
export const minimalConfig: ProcessExceptionOptions = {
  enableErrorHandler: true,
