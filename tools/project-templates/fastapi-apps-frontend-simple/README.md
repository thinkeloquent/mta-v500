...
```bash
npm run create:fastapi-frontend app-my-feature
...
This creates:
```
fastapi-apps/app-my-feature/frontend/
├── src/
...
| Placeholder | Example (for `app-my-feature`) |
|-------------|--------------------------------|
| `{{APP_NAME}}` | `app-my-feature` |
...
```bash
# Build
nx build @internal/app-my-feature-frontend

# Development
nx dev @internal/app-my-feature-frontend

# Test
nx test @internal/app-my-feature-frontend
```
