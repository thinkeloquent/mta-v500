/**
 * API Client for App Google Gemini Openai Chat Completions
 *
 * This module provides functions to interact with the FastAPI backend.
 */

// Base URL for API requests
// When served through MTA orchestrator, use the app-specific API path
export const API_BASE = import.meta.env.VITE_API_URL || '/api/apps/google-gemini-openai-chat-completions';
