...
const API_BASE = BACKEND_DOMAIN
  ? `${BACKEND_DOMAIN}/api/apps/persona-editor`
  : '/api/apps/persona-editor';
...
export const personasAPI = {
  list: async (): Promise<Persona[]> => {
    try {
      ...
      console.error('Failed to fetch personas, returning mock data:', error);
  ...
  create: async (data: Omit<Persona, 'id' | 'last_updated'>): Promise<Persona> => {
    try {
      ...
      console.error('Failed to create persona, using mock:', error);
      // Return a mock created persona
  ...
  update: async (id: string, data: Partial<Persona>): Promise<Persona> => {
    try {
      ...
      console.error('Failed to update persona, using mock:', error);
