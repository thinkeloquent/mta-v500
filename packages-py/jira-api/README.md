...
```bash
# Using pip
pip install -e /Users/Shared/autoload/mta-v500/packages/jira-api

# Using Poetry
poetry add /Users/Shared/autoload/mta-v500/packages/jira-api
```
...
- **[Figma API](../figma-api/)**: Similar async-first SDK for Figma API
- **[Original Jira API Module](../../jira-api-module/)**: Full-featured package with CLI and server
