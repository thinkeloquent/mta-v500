...
await fastify.register(fastifyStatic, {
  ...
  prefix: '/static/app/google-gemini-openai-chat-completions/frontend/dist/',
});
...
fastify.log.info('✓ Google Gemini Openai Chat Completions plugin registered');
...
const start = async () => {
  try {
    ...
    fastify.log.info('🚀 Starting Google Gemini Openai Chat Completions Server...');
    fastify.log.info(
      {
        port,
        host,
    ...
    fastify.log.info(`✓ API endpoint: http://localhost:${port}/api/google-gemini-openai-chat-completions`);
