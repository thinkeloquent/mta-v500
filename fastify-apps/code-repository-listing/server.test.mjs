...
await fastify.register(fastifyStatic, {
  ...
  prefix: '/static/app/code-repository-listing/frontend/dist/',
});
...
fastify.log.info('✓ Code Repository Listing plugin registered');
...
const start = async () => {
  try {
    ...
    fastify.log.info('🚀 Starting Code Repository Listing Server...');
    fastify.log.info(
      {
        port,
        host,
    ...
    fastify.log.info(`✓ API endpoint: http://localhost:${port}/api/code-repository-listing`);
