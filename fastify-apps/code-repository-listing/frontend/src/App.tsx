...
// --- Repo Editor Modal ---
const RepoEditorModal = ({ isOpen, onClose, onSave, setError, repoToEdit }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const repoData = {
            ...repo,
            tags: repo.tags.split(',').map(tag => tag.trim()).filter(Boolean),
        };
...
function App() {
  ...
  const [editingRepo, setEditingRepo] = useState(null); // Can be a repo object or null
