...
/**
 * Gets the AI model instance for the request
 ...
 */
function getModelForRequest(request) {
 ...
 */
export async function handleDataStream(request, reply) {
  try {
 ...
 */
export async function handleTextStream(request, reply) {
  try {
    const { messages } = request.body;
    const model = getModelForRequest(request);
 ...
 */
export async function handleCustomDataStream(request, reply) {
  try {
    const { messages } = request.body;
    const model = getModelForRequest(request);
 ...
 * Uses X-Vercel-AI-Data-Stream header with v1 protocol
 */
export async function handleDataStreamPrompt(request, reply) {
  try {
 ...
 * Returns only the text content as a stream
 */
export async function handleTextStreamPrompt(request, reply) {
  try {
    const { prompt } = request.body;
    const model = getModelForRequest(request);
 ...
 * Provides fine-grained control with custom data and error handling
 */
export async function handleCustomDataStreamPrompt(request, reply) {
  try {
    const { prompt } = request.body;
    const model = getModelForRequest(request);
