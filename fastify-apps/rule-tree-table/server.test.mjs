...
fastify.log.info('✓ Rule Tree Table plugin registered');
...
const start = async () => {
  try {
    ...
    fastify.log.info('🚀 Starting Rule Tree Table Server...');
    fastify.log.info(
      {
        port,
        host,
    ...
    fastify.log.info(`✓ API endpoint: http://localhost:${port}/api/rule-tree-table`);
